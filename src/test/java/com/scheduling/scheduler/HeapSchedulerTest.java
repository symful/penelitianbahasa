...
class HeapSchedulerTest {

    private HeapScheduler scheduler;
    private Task task1;
    private Task task2;
    private Task task3;
    ...
    @Test
    void pollNextTask_ReturnsNull_WhenQueueIsEmpty() {
        Task result = scheduler.pollNextTask();
        assertNull(result, "pollNextTask should return null when queue is empty");
    }
